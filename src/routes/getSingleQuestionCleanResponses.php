...
$app->post('/api/HuffingtonPostPollster/getSingleQuestionCleanResponses', function ($request, $response) {
    ...
    $url = $settings['apiUrl'] . "/questions/" . $postData['args']['slug'] . "/poll-responses-clean.tsv";
