...
$app->post('/api/HuffingtonPostPollster/getPollsterChartData', function ($request, $response) {
    ...
    $url = $settings['apiUrl'] . "/charts/" . $postData['args']['slug'] . "/pollster-chart-poll-questions.tsv";
